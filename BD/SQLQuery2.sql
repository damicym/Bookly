...
BEGIN TRY
    ...
    VALUES
    ('45000111', 4800,  1, 1, 'Con algunas anotaciones', '2025-10-01', 'Libro de Ciencias Naturales con pocas marcas.',                NULL),
    ('45000111', 5200,  7, 1, 'Como nuevo',              '2025-09-25', 'Perfecto estado, casi sin uso.',                               NULL),
    ('45000222', 3000,  6, 1, 'Muy usado',               '2025-09-20', 'Subrayado en varias páginas, útil para repaso.',               NULL),
    ...
    ('45000333', 3200,  3, 1, 'Con algunas anotaciones', '2025-08-15', 'Toldot 2 en buen estado general.',                            NULL),
    ('45000444', 4000,  9, 1, 'Como nuevo',              '2025-07-12', 'Introducción a la programación en excelente estado.',          NULL),
    ('45000444', 2800,  4, 1, 'Muy usado',               '2025-07-20', 'Toldot 3 con apuntes útiles.',                                NULL),
    ('45000555', 3600,  8, 1, 'Con algunas anotaciones', '2025-06-05', 'Libro de geografía con subrayados leves.',                    NULL),
    ('45000555', 5000,  7, 1, 'Como nuevo',              '2025-06-10', 'Biología y ambiente sin uso.',                                 NULL),
    ('45000666', 4700,  1, 1, 'Muy usado',               '2025-05-18', 'Ciencias Naturales 7 con apuntes de clase.',                  NULL),
    ...
    ('45000777', 4500,  8, 1, 'Con algunas anotaciones', '2025-04-18', 'Subrayado en pocas páginas.',                                 NULL),
    ('45000888', 2900,  2, 1, 'Muy usado',               '2025-03-10', 'Toldot 1 con varias notas útiles.',                           NULL),
    ('45000888', 3100,  3, 1, 'Con algunas anotaciones', '2025-03-12', 'Usado pero bien conservado.',                                 NULL),
    ...
    ('45000999', 4200,  1, 1, 'Con algunas anotaciones', '2025-02-15', 'Ciencias Naturales en buen estado.',                          NULL),
    ...
    ('45001010', 3500,  8, 1, 'Con algunas anotaciones', '2025-01-28', 'Con mapas y gráficos subrayados.',                            NULL),
    ('45000111', 4600, 10, 1, 'Con algunas anotaciones', '2025-10-10', 'Educación Cívica Hoy, leve subrayado.',                       NULL),
    ...
    ('45000444', 3100,  2, 1, 'Muy usado',               '2025-07-29', 'Toldot 1 con apuntes detallados.',                            NULL),
    ...
    ('45000777', 3300,  8, 1, 'Con algunas anotaciones', '2025-04-30', 'Buen estado general, con mapas.',                             NULL),
    ('50542543', 4300, 11, 1, 'Muy usado',               '2025-03-29', 'Anotaciones útiles, buen estado general.',                    NULL),
    ('50542543', 7300, 12, 1, 'Con algunas anotaciones', '2025-03-27', 'Anotaciones leves en pocas páginas, perfecto estado.',        NULL),
    ('50542543', 8300, 13, 1, 'Con algunas anotaciones', '2025-03-29', 'Tiene algunas anotaciones, aún así está en muy buen estado.', NULL),
    ('50542543', 5300, 14, 1, 'Muy usado',               '2025-03-29', 'Anotaciones útiles, buen estado general.',                    NULL),
